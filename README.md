# Schedule-X Premium changelog

Customer-facing release notes for [Schedule-X Premium](https://schedule-x.dev/premium).
...
* **gantt:** keep task labels visible when task bars are clipped

## 15.7.0 (2026-09-03)

### Bug Fixes

* **gantt:** keep stacked day labels within the timeline
* **gantt:** make zoom controls easier to see and use
* **gantt:** prevent the add-task hint from overlapping task bars
* **gantt:** improve readability of compact time headers

### Features

* **gantt:** add timeline zoom controls
* **gantt:** show full task titles in a tooltip when they are truncated

## 15.6.0 (2026-09-02)

### Features

* **gantt:** add translations and inherit the predecessor task's parent

## 15.5.0 (2026-08-31)

### Features

* add the Gantt chart view
* **drag-and-drop:** support dragging events from the date grid to the time grid
